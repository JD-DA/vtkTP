...
Puis une fois toutes le manipulations cmake faites vous pouvez lancer le code avec cette commande mais il est possible que vous soyez contrain de mettre plus de coeur sur votre VM:
